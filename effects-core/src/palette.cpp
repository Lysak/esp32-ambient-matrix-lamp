...
Rgb color_from_palette(const Palette16& pal, uint8_t index, uint8_t brightness) {
    ...
    Rgb r{lerp8u(c0.r, c1.r, blend), lerp8u(c0.g, c1.g, blend), lerp8u(c0.b, c1.b, blend)};
    if (brightness < 255) {
...
const Palette16& palette_by_id(PaletteId id) {
    ...
    case PaletteId::Lava:
        return kLavaColors;
    case PaletteId::Party:
        return kPartyColors;
    case PaletteId::Rainbow:
        return kRainbowColors;
    case PaletteId::RainbowStripe:
        return kRainbowStripeColors;
    case PaletteId::Cloud:
        return kCloudColors;
    case PaletteId::Ocean:
        return kOceanColors;
    case PaletteId::Forest:
        return kForestColors;
    }
    return kRainbowColors;
}
...
const Palette16 kRainbowColors = {{
    Rgb::from_hsv(0,   255, 255),
    Rgb::from_hsv(17,  255, 255),
    Rgb::from_hsv(34,  255, 255),
    Rgb::from_hsv(51,  255, 255),
    Rgb::from_hsv(68,  255, 255),
    Rgb::from_hsv(85,  255, 255),
    Rgb::from_hsv(102, 255, 255),
    Rgb::from_hsv(119, 255, 255),
    Rgb::from_hsv(136, 255, 255),
    Rgb::from_hsv(153, 255, 255),
    Rgb::from_hsv(170, 255, 255),
    Rgb::from_hsv(187, 255, 255),
    Rgb::from_hsv(204, 255, 255),
    Rgb::from_hsv(221, 255, 255),
    Rgb::from_hsv(238, 255, 255),
    Rgb::from_hsv(255, 255, 255),
}};
